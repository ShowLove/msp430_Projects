/*
The purpose of this program was to provide the C Language implementation to toggle the Green and Yellow LEDs of the MSP430 upon pressing the 'G' and 'Y' characters on the keyboard
*/
...
str .string "Laboratory #2 for EEL4742 Embedded Systems" ; String to print to console
...
; a time
;----------------------------------------------------------------
	mov.w #str, R6 ; get address of first character into R4
printChar
	mov.b @R6+,  R4
	cmp.b #0x00, R4
