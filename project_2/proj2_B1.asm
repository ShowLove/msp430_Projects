;This code provided the necessary Assembly language implementation to send a character to
; the MSP430 through HyperTerminal and have the MSP430 echo the character back to ;HyperTerminal for feedback.
