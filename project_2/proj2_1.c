/*
	This code provided the necessary C implementation to send a character to the MSP430 
	through HyperTerminal and have the MSP430 echo the character back to HyperTerminal for 
	feedback.
*/
	
Figure 1: MP430FG4618 UART-Print Character to HyperTerminal in C
//---------------------------------------------------------------
